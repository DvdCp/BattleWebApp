...
class PaletteRecord(BiffRecord):
    ...
    08H             First user-defined colour from the PALETTE record (app 0 from record colour list)
    .........................

    17H (BIFF3-BIFF4) Last user-defined colour from the PALETTE record (app 15 or 55 from record colour list)
    3FH (BIFF5-BIFF8)
