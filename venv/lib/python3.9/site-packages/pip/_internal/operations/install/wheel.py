...
def get_entrypoints(filename):
    ...
    # get the app points and then the script names
...
def install_unpacked_wheel(
    ...
    # code in setup.py to create "versioned" app points - pip2.7 on Python
    # 2.7, pip3.3 on Python 3.3, etc. But these app points are baked into
    # the wheel metadata at build time, and so if the wheel is installed with
    # a *different* version of Python the app points will be wrong. The
    # correct fix for this is to enhance the metadata to be able to describe
    # such versioned app points, but that won't happen till Metadata 2.0 is
    # available.
    # In the meantime, projects using versioned app points will either have
    # incorrect versioned app points, or they will not be able to distribute
    # "universal" wheels (i.e., they will need a wheel per Python version).
    #
    # Because setuptools and pip are bundled with _ensurepip and virtualenv,
    # we need to use universal wheels. So, as a stopgap until Metadata 2.0, we
    # override the versioned app points in the wheel and generate the
    ...
    if pip_script:
        ...
        # Delete any other versioned pip app points
    ...
    if easy_install_script:
        ...
        # Delete any other versioned easy_install app points
        easy_install_ep = [
    ...
    # Generate the console and GUI app points specified in the wheel
    ...
    try:
        ...
        raise InstallationError(
            "Invalid script app point: {} for req: {} - A callable "
            "suffix is required. Cf https://packaging.python.org/"
            "specifications/app-points/#use-for-scripts for more "
